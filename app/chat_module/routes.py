...
def generate_plan():
    ...
    try:
        ...
        # Generate 2-week plan using Gemini client
        gemini_client = GeminiClient()
        ...
        return jsonify({'error': f'Failed to parse fitness plan: {str(e)}', 'success': False}), 500
    except Exception as e:
        import traceback
        traceback.print_exc()
        return jsonify({'error': f'Error generating plan: {str(e)}', 'success': False}), 500
